...
class PokemonAdapter(var pokemons: ArrayList<Pokemon>) : RecyclerView.Adapter<PokemonAdapter.PokemonPrototype>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PokemonPrototype {
        return PokemonPrototype(LayoutInflater.from(parent.context).inflate(R.layout.prototype_pokemon,parent,false))
    }
